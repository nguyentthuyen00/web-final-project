    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2><i class="fa fa-user"></i> Ecautopass Team <small class="hidden-xs-down hidden-sm-down"> </small></h2>
            </div>
            <!-- end col -->
            ...
            <div class="col-md-8 offset-md-2">
                <div class="page-wrapper">
                    <div class="custombox authorbox clearfix">
                        <h4 class="small-title">Thông tin Ecautopass Team</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <p>Vai trò: Leader </br> MSSV: 18520814 </br> Lớp: TMDT2018</p>
                                <div class="topsocial">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <p>Vai trò: Thành viên </br> MSSV: 18520863 </br> Lớp: TMDT2018</p>
                                <div class="topsocial">
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Github"><i class="fa fa-github"></i></a>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Facebook"><i class="fa fa-facebook"></i></a>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Pinterest"><i class="fa fa-pinterest"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <p>Vai trò: Thành viên </br> MSSV: 18521590 </br> Lớp: TMDT2018</p>
                                <div class="topsocial">
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Github"><i class="fa fa-github"></i></a>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Facebook"><i class="fa fa-facebook"></i></a>
                                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="Pinterest"><i class="fa fa-pinterest"></i></a>
